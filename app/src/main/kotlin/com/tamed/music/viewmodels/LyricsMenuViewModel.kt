...
import com.tamed.music.ai.AiLyricsTranslator
import com.tamed.music.ai.AiServiceConfig
import com.tamed.music.constants.AiApiKeyKey
import com.tamed.music.constants.AiApiValidationStatus
import com.tamed.music.constants.AiApiValidationStatusKey
import com.tamed.music.constants.AiCustomEndpointKey
import com.tamed.music.constants.AiCustomModelKey
import com.tamed.music.constants.AiProvider
import com.tamed.music.constants.AiProviderKey
import com.tamed.music.constants.AiSelectedModelKey
import com.tamed.music.constants.TranslatorTargetLangKey
...
import com.tamed.music.lyrics.LyricsResult
import com.tamed.music.lyrics.LyricsUtils
import com.tamed.music.lyrics.LyricsUtils.displayLyricsText
    ...
    constructor(
        ...
        fun refetchLyrics(mediaMetadata: MediaMetadata) {
            viewModelScope.launch(Dispatchers.IO) {
                ...
                try {
                    val lyrics = lyricsHelper.getLyrics(mediaMetadata, ignoreCache = true)
                    database.query {
                        replaceLyrics(
                            id = mediaMetadata.id,
                            lyrics = lyrics,
