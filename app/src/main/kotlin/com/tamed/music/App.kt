...
import com.tamed.music.ui.theme.ThemeSeedPalette
import com.tamed.music.ui.theme.ThemeSeedPaletteCodec
...
import com.tamed.music.utils.clearPlaybackAuthSession
...
import com.tamed.music.utils.toPlaybackAuthState
...
class App : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        Timber.plant(Timber.DebugTree())
        try {
            Timber.plant(com.tamed.music.utils.GlobalLogTree())
        } catch (_: Exception) {}
    ...
    companion object {
        ...
        fun launchOnAppScope(block: suspend CoroutineScope.() -> Unit) =
            instance.applicationScope.launch(block = block)
