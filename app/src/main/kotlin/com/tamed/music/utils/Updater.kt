...
import com.tamed.music.constants.GitHubReleasesEtagKey
import com.tamed.music.constants.GitHubReleasesFingerprintKey
import com.tamed.music.constants.GitHubReleasesJsonKey
import com.tamed.music.constants.GitHubReleasesLastCheckedAtKey
...
object Updater {
    ...
    private suspend fun fetchReleasesNetwork(
        ...
        val response: HttpResponse =
            client.get("https://api.github.com/repos/tamedapp/tamed/releases?per_page=$perPage") {
                headers {
                    append("Accept", "application/vnd.github+json")
                    append("User-Agent", "Tamed")
    ...
    suspend fun getCommitHistory(count: Int = 20, branch: String = "dev"): Result<List<GitCommit>> =
        runCatching {
            val response =
                client.get("https://api.github.com/repos/tamedapp/tamed/commits?sha=$branch&per_page=$count")
                    .bodyAsText()
    ...
    fun getLatestDownloadUrl(): String {
        val baseUrl = "https://tamed.app/releases/latest/download/"
