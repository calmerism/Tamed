...
fun DynamicSearchPlaceholder(
    ...
    val promptWhatsOnMind = "What's on your mind?"
    val promptTodaysPick = "Today's pick"
    val promptTrending = "Search trending tracks"
    val promptVibe = "Find your vibe"
    val promptSongsArtists = "Search songs, artists, albums"

    val templateSong = "%s"
    val templateSongTry = "Try %s"
    val templateArtist = "More from %s"
