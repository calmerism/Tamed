...
import com.tamed.music.constants.HistorySource
...
import com.tamed.music.viewmodels.DateAgo
import com.tamed.music.viewmodels.HistoryViewModel
    ...
    AmbientBackdrop(modifier = Modifier.fillMaxSize()) {
        ...
        LazyColumn(
            ...
            contentPadding = PaddingValues(
                top = 0.dp,
                bottom = LocalPlayerAwareWindowInsets.current.asPaddingValues().calculateBottomPadding() + 100.dp,
                start = LocalPlayerAwareWindowInsets.current.asPaddingValues().calculateStartPadding(LocalLayoutDirection.current),
                end = LocalPlayerAwareWindowInsets.current.asPaddingValues().calculateEndPadding(LocalLayoutDirection.current)
            ),
                    ...
                    Column(
                        ...
                        Row(
                            ...
                            Column(
                                ...
                                Text(
                                    text = "Tracks you played recently, grouped by time.",
