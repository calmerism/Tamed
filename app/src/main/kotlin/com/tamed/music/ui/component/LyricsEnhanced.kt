...
import com.tamed.music.LocalAnimationsDisabled
...
import com.tamed.music.lyrics.LyricsUtils.providedRomanizedWordsForEntry
...
import com.tamed.music.lyrics.LyricsUtils.romanizeLyricsWordWithLineContext
                        ...
                        KaraokeLyricsView(
                            ...
                            onLineClicked = { line ->
                                if (isSelectionModeActive) {
                                    ...
                                    val targetPos = (line.start.toLong() + lyricsSyncOffset).coerceAtLeast(0L)
...
private fun PlainLyricLineItem(
    ...
    val contentColor =
        if (selected) {
            ...
            textColor.copy(alpha = 0.90f)
        }

    Text(
        text = line.text,
        style = textStyle.copy(lineHeight = (textStyle.fontSize.value * 1.35f).sp),
        color = contentColor,
