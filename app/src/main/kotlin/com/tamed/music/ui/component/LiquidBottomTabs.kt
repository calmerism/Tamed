...
import com.tamed.music.ui.component.layerBackdropSafe
import com.kyant.backdrop.backdrops.rememberCombinedBackdrop
import com.tamed.music.ui.component.rememberLayerBackdropSafe
...
fun LiquidBottomTabs(
    ...
    accentColor: Color = if (!isSystemInDarkTheme()) Color(0xFFFA243C) else Color(0xFFFA243C),
    searchProgress: Float = 0f,
    collapseProgress: Float = 0f,
    content: @Composable RowScope.() -> Unit
) {
    val isCollapsing = collapseProgress > 0.001f && collapseProgress < 0.999f
    val tabsBackdrop = rememberLayerBackdropSafe()
        ...
        CompositionLocalProvider(
            ...
            Row(
                Modifier
                    ...
                    .alpha(0f)
                    .layerBackdropSafe(tabsBackdrop)
                    .graphicsLayer {
                        translationX = panelOffset
                    }
                    .drawBackdropSafe(
            ...
            Modifier
                ...
                .drawBackdropSafe(
                    ...
                    innerShadow = {
                        val progress = dampedDragAnimation.pressProgress
                        InnerShadow(
                            radius = if (isCollapsing) 0.dp else 8.dp * progress,
