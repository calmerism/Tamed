...
package com.tamed.music.ui.component.floatingtabbar
...
import com.tamed.music.ui.component.LocalGlassEffectConfig
import com.tamed.music.ui.component.glassResolutionScale
import com.tamed.music.ui.component.backdrop.Backdrop
import com.tamed.music.ui.component.backdrop.backdrops.layerBackdrop
import com.tamed.music.ui.component.backdrop.backdrops.rememberCombinedBackdrop
import com.tamed.music.ui.component.backdrop.backdrops.rememberLayerBackdrop
import com.tamed.music.ui.component.backdrop.catalog.utils.DampedDragAnimation
import com.tamed.music.ui.component.backdrop.catalog.utils.InteractiveHighlight
import com.tamed.music.ui.component.backdrop.drawBackdrop
import com.tamed.music.ui.component.backdrop.effects.blur
import com.tamed.music.ui.component.backdrop.effects.lens
import com.tamed.music.ui.component.backdrop.effects.vibrancy
import com.tamed.music.ui.component.backdrop.highlight.Highlight
import com.tamed.music.ui.component.backdrop.shadow.InnerShadow
import com.tamed.music.ui.component.backdrop.shadow.Shadow
                    ...
                    if (backdrop != null) {
                        Modifier.drawBackdrop(
                            ...
                            onDrawSurface = {
                                ...
                                // while pressed.
                                val progress = dampedDragAnimation.pressProgress
                                val puckColor = if (isLightMode) Color(235, 235, 240, 255) else Color(28, 27, 28, 255)
                                drawRect(puckColor.copy(alpha = 0.8f - 0.6f * progress))
                            },
                            frozen = LocalTabBarBackdropFrozen.current
                        )
                    } else {
