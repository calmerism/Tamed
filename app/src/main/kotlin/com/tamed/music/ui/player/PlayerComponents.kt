...
fun PlayerTitleSection(
    ...
    AnimatedContent(
        targetState = displayTitle to mediaMetadata.explicit,
    ...
    val annotatedString = buildAnnotatedString {
        mediaMetadata.artists.forEachIndexed { index, artist ->
            ...
            withStyle(SpanStyle(color = textBackgroundColor, fontSize = 16.sp, fontWeight = FontWeight.Normal)) {
                append(artist.name)
            }
            pop()
    ...
    Box(
        ...
        Text(
            ...
            style = MaterialTheme.typography.titleMedium.copy(color = textBackgroundColor, fontWeight = FontWeight.Normal),
            maxLines = 1,
            overflow = TextOverflow.Ellipsis,
