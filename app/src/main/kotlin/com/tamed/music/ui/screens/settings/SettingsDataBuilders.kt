            ...
            items = buildList {
                ...
                add(
                    SettingsItem(
                        icon = painterResource(R.drawable.play),
                        title = "Player",
                        subtitle = "Audio quality, crossfade, and providers",
                        accentColor = MaterialTheme.colorScheme.tertiary,
                ...
                add(
                    SettingsItem(
                        ...
                        title = "Lyrics",
                        subtitle = "Translation, text size, and scroll speed",
                        accentColor = MaterialTheme.colorScheme.secondary,
                ...
                add(
                    SettingsItem(
                        ...
                        subtitle = "Identify tracks playing around you",
                        accentColor = MaterialTheme.colorScheme.tertiary,
                ...
                add(
                    SettingsItem(
                        ...
                        subtitle = "Your listening statistics and top plays",
                        accentColor = MaterialTheme.colorScheme.primary,
                ...
                add(
                    SettingsItem(
                        ...
                        title = "History",
                        subtitle = "Recently played tracks and listening log",
                        accentColor = MaterialTheme.colorScheme.primary,
                        keywords = listOf("shuffle", "permanent shuffle", "random play", "queue", "history"),
                        onClick = { resetSearch(); navController.navigate("history") },
                    )
                )
                add(
                    SettingsItem(
                        ...
                        subtitle = "Manage cached files and offline downloads",
                        accentColor = MaterialTheme.colorScheme.secondary,
                ...
                add(
                    SettingsItem(
                        ...
                        title = "Miscellaneous",
                        subtitle = "Experimental settings and diagnostics",
                        accentColor = MaterialTheme.colorScheme.tertiary,
                ...
                if (isAndroid12OrLater) {
                    add(
                        SettingsItem(
                            ...
                            subtitle = "Configure supported web addresses",
                            accentColor = MaterialTheme.colorScheme.primary,
