        ...
        fun onSongChanged(
            ...
            scope.launch {
                try {
                    ...
                    if (context.isLowDataModeActive(preferences[NetworkMeteredKey] ?: true)) {
...
private fun android.content.Context.isLowDataModeActive(enabled: Boolean): Boolean {
    if (!enabled) return false
    val connectivityManager = getSystemService(android.content.Context.CONNECTIVITY_SERVICE) as? android.net.ConnectivityManager ?: return false
