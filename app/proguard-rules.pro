...
-keep class com.tamed.music.models.PersistQueue { *; }
-keep class com.tamed.music.models.PersistPlayerState { *; }
-keep class com.tamed.music.models.QueueData { *; }
-keep class com.tamed.music.models.QueueType { *; }
-keep class com.tamed.music.playback.queues.** { *; }
