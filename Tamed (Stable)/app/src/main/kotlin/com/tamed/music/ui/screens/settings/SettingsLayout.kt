...
@Composable
private fun rememberIntegrationGroup(
    ...
    return SettingsGroup(
        ...
        items = integrations.map { integration ->
            SettingsItem(
                ...
                keywords = listOf(integration.label),
...
private fun CompactSettingsLayout(
    ...
    val spacing = 18.dp
    val integrationGroup = rememberIntegrationGroup(state.integrations)
        ...
        item(key = "hero") {
            SettingsProfileHeader(
                ...
                modifier = Modifier
                    ...
                    .padding(top = 10.dp, bottom = spacing),
            )
        }
