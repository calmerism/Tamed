...
import com.tamed.music.ui.component.LyricsV2
...
fun LyricsScreen(
    ...
    // Gradient colors are now passed directly from Player to avoid heavy extraction causing UI stutter
    ...
    Box(modifier = modifier.fillMaxSize()) {
        Box(modifier = Modifier.fillMaxSize()) {
            PlayerBackground(
                ...
                appleMusicLyricsBlurBackdrop = playerBackground == PlayerBackgroundStyle.APPLE_MUSIC,
            )
        }
