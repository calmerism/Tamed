...
import com.tamed.music.lastfm.models.Authentication
import com.tamed.music.lastfm.models.LastFmError
import com.tamed.music.lastfm.models.TokenResponse
...
object LastFM {
    ...
    private fun Map<String, String>.apiSig(secret: String): String {
        ...
        val toHash = sorted.joinToString("") { it.key + it.value } + secret
    ...
    private fun HttpRequestBuilder.lastfmParams(
        ...
        userAgent("Tamed (https://tamed.app)")
