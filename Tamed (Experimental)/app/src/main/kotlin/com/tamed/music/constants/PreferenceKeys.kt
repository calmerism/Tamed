...
val TamedCanvasKey = booleanPreferencesKey("tamedCanvas")
...
val LosslessStreamingProviderKey = stringPreferencesKey("losslessStreamingProvider")

enum class LosslessStreamingProvider(val service: String?) {
    OFF(null),
    QOBUZ("qobuz"),
}

val LosslessStreamingQualityKey = stringPreferencesKey("losslessStreamingQuality")

enum class LosslessStreamingQuality(val requestValue: String) {
    LOSSLESS("LOSSLESS"),
    HI_RES("HI_RES"),
    HI_RES_MAX("HI_RES_MAX"),
}
...
// Apple Music fallback / Qobuz configuration
val AppleMusicFallbackKey = booleanPreferencesKey("appleMusicFallback")
...
// Artist screen display preferences
...
fun PlayerDesignStyle.asSupportedPlayerDesignStyle(): PlayerDesignStyle =
    when (this) {
